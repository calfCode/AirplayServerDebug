...
RAOP_API void raop_set_port(raop_t *raop, unsigned short port,unsigned short airplayPort);
RAOP_API unsigned short raop_get_port(raop_t *raop);

RAOP_API unsigned short raop_get_airplay_port(raop_t *raop);
RAOP_API void *raop_get_callback_cls(raop_t *raop);
RAOP_API int raop_start(raop_t *raop, unsigned short *port,unsigned short *airplayPort);
